            ...
            <div className="signup-wrapper">
                <div className="signup-left">
                    ...
                    <form onSubmit={handleSubmit}> 
                        ...
                        <input type='password'placeholder='password' name='password'ref = { passwordRef} required/>
                        <label htmlFor='confirmpassword'>Confirm Password</label>
                        <input type='password' placeholder='confirm password' name='confirmpassword'ref = { passwordConfirmRef} required/>
